 ...
 *
 */
func UpgradeServerConnection(client net.Conn, role string) net.Conn {
 ...
 *
 */
func UpgradeClientConnection(hostPort string, connection net.Conn, role string) net.Conn {
	verifyCA := false
